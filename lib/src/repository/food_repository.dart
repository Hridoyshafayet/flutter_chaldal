...
Future<Stream<Food>> getFood(String foodId) async {
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}foods/$foodId?with=nutrition;restaurant;category;extras;foodReviews;foodReviews.user';
...
Future<Stream<Food>> getFoodsByCategory(categoryId) async {
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}foods?with=restaurant&search=category_id:$categoryId&searchFields=category_id:=';
...
Future<Stream<Food>> getFeaturedFoodsOfRestaurant(String restaurantId) async {
  ...
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}foods?with=restaurant&search=restaurant_id:$restaurantId&searchFields=restaurant_id:=';
